...
public class MainActivity extends AppCompatActivity {
            ...
            try {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    if (contenido.length == 3) {
                        ...
                        String listaCont = listaTit + ": "+contenido[1]+" - "+contenido[2];
  ...
  //------------------------------------------------------------------------------------------------
            ...
            fab_Principal.setVisibility(View.INVISIBLE);
                    ...
                    dialogo.setTitle("Aviso")
                            ...
                            .setPositiveButton("Confirmar", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    for( i = 0; i < elementosMarcados.size(); i++){
                                        int llave = elementosMarcados.keyAt(i);
                                        boolean valor = elementosMarcados.get(llave);
                                        if(valor){
                                            //seleccionados.add(lstvNotas.getItemAtPosition(llave).toString());
                                            //seleccionados.clear();
                                            String idTit;
                                            String idCont;
                                            String idPath;

                                            idTit = mydb.getId(lstTitulos.get(i));
                                            mydb.deleteOneRow(idTit);
                                            idCont = mydb.getId(lstContenidos.get(i));
                                            mydb.deleteOneRow(idCont);
                                            idPath = mydb.getId(lstPaths.get(i));
                                            mydb.deleteOneRow(idPath);
                                    ...
                                    btnEliminarNotas.setVisibility(View.INVISIBLE);
                                    fab_Principal.setVisibility(View.VISIBLE);
